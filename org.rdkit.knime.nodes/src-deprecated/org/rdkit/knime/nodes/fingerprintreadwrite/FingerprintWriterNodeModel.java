...
public class FingerprintWriterNodeModel extends NodeModel {
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs)
        ...
        File file = FPSReadWriteUtil.checkFile(m_outputFile, false, false);
        if (file.isDirectory()) {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        File outFile = FPSReadWriteUtil.checkFile(m_outputFile, false, false);
        ...
        try {
	        ...
	        for (DataRow r : in) {
	            ...
	            if(!m_writeRowid && colIndexId != -1) {
	            	DataCell idCell = r.getCell(colIndexId);
	            	if (!idCell.isMissing()) {
