...
public final class AdditionalHeaderInfo {
	...
	static {
		registerHandler(new AdditionalHeaderInfoHandler() {
			 ...
			 */
			@Override
			public Object prepareValue(final String value) {
	 ...
	 */
	public AdditionalHeaderInfo(final DataColumnSpec colSpec) {
		if (colSpec != null) {
			...
			if (m_strAddInfoType != null) {
				...
				final String addInfoInitHeight = props.getProperty(HEADER_PROP_INITIAL_HEIGHT);
	 ...
	 */
	public AdditionalHeaderInfo(final String strType, final String strValue, final int iInitialHeight) {
	 ...
	 */
	public DataColumnSpec removeFromColumnSpec(final DataColumnSpec spec) {
		DataColumnSpec specRet = spec;

		if (spec != null) {
			final AdditionalHeaderInfo headerInfo = new AdditionalHeaderInfo(spec);
	...
	public Object prepareValue() {
		final AdditionalHeaderInfoHandler handler = getHandler(getType());
	...
	public Icon createIconWrapper(final JTable table, final int column,
		...
		if (isAvailable()) {
			...
			final TableCellRenderer renderer = getRenderer();
	 ...
	 */
	public static void registerHandler(final AdditionalHeaderInfoHandler handler) {
	 ...
	 */
	public static void unregisterHandler(final String type) {
		if (type != null) {
	 ...
	 */
	public static boolean canHandle(final String type) {
	 ...
	 * 		been registered.
	 */
	public static AdditionalHeaderInfoHandler getHandler(final String type) {
