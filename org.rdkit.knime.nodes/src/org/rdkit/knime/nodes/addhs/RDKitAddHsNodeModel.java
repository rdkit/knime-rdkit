...
/**
 * This class implements the node model of the RDKitAddHs node
 * providing calculations based on the open source RDKit library.
 * Adds hydrogens to an RDKit molecule.
 * @author Manuel Schwarze
 */
public class RDKitAddHsNodeModel extends AbstractRDKitCalculatorNodeModel {
	...
	private final SettingsModelString m_modelInputColumnName =
			registerSettings(RDKitAddHsNodeDialog.createInputColumnNameModel());
	...
	private final SettingsModelString m_modelNewColumnName =
			registerSettings(RDKitAddHsNodeDialog.createNewColumnNameModel());
	...
	private final SettingsModelBoolean m_modelRemoveSourceColumns =
			registerSettings(RDKitAddHsNodeDialog.createRemoveSourceColumnsOptionModel());
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs)
		...
		SettingsUtils.autoGuessColumnName(inSpecs[0], null,
				(m_modelRemoveSourceColumns.getBooleanValue() ?
						...
						m_modelNewColumnName, strInputColumnName + " (Added Hs)");
