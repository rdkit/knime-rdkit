...
public class RDKitAromatizeNodeFactory 
     ...
     */
    @Override
    public RDKitAromatizeNodeModel createNodeModel() {
        return new RDKitAromatizeNodeModel();
    }
     ...
     */
    @Override
    public NodeView<RDKitAromatizeNodeModel> createNodeView(
            final int viewIndex,
            final RDKitAromatizeNodeModel nodeModel) {
        return null;
    }
