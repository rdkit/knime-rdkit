...
/**
 * <code>NodeDialog</code> for the "RDKitChemicalTransformation" Node.
 ...
 */
public class RDKitChemicalTransformationNodeDialog extends DefaultNodeSettingsPane {

	//
	// Constants
	//

	/** The default value for maximum number of reactions for each reaction. */
	public static int DEFAULT_MAX_REACTION_CYCLES = 100;
	...
	RDKitChemicalTransformationNodeDialog() {
		super.addDialogComponent(new DialogComponentColumnNameSelection(
				...
				RDKitMolValue.class));
		super.addDialogComponent(new DialogComponentColumnNameSelection(
				createReactionInputColumnNameModel(), "Reaction column (table 2): ", 1,
		...
		super.addDialogComponent(new DialogComponentNumber(
				createMaxReactionCyclesOptionNameModel(), "Maximal number of applied reaction cycles: ", 1, 5));
	}
	...
	/**
	 * Creates the settings model to be used for the mol input column (table 1).
	 * 
	 * @return Settings model for input column selection.
	 */
	static final SettingsModelString createMolInputColumnNameModel() {
		return new SettingsModelString("input_mol_column", null);
	}

	/**
	 * Creates the settings model to be used for the reaction input column (table 2).
	 * 
	 * @return Settings model for input column selection.
	 */
	static final SettingsModelString createReactionInputColumnNameModel() {
		return new SettingsModelString("input_reaction_column", null);
	}
	 ...
	 * @return Settings model for input column selection.
	 */
	static final SettingsModelIntegerBounded createMaxReactionCyclesOptionNameModel() {
		return new SettingsModelIntegerBounded("max_reaction_cycles", DEFAULT_MAX_REACTION_CYCLES, 1, 9999);
	}
