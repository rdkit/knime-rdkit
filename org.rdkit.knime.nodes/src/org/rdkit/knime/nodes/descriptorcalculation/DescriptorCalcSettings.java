...
/**
 * This class stores the settings the user can set in the DescriptorCalculationNodeDialog dialog pane.
 * 
 * @author Dillip K Mohanty
 */

public class DescriptorCalcSettings
{
	/** The molecule column name. */
   public String colName;
   
   /** The array selected descriptors. */
   public String[] selectedDescriptors;
         ...
         throws InvalidSettingsException
   {
      ...
      selectedDescriptors = settings.getStringArray("selectedDescriptors");
   }
   ...
   {
      colName = settings.getString("colName", "");
      selectedDescriptors = settings.getStringArray("selectedDescriptors", new String[]{});
   }
   ...
   public void saveSettings (final NodeSettingsWO settings)
   {
      ...
      if (selectedDescriptors != null) {
         settings.addStringArray("selectedDescriptors", selectedDescriptors);
      }
   }
}
