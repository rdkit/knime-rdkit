...
public class FunctionalGroup {
	 ...
	 */
	public FunctionalGroup(final String strLine) throws ParseException {
		if (strLine == null) {
	 ...
	 */
	public FunctionalGroup(final String uniqueName, final String smarts, final String label,
			final String removalReaction, final String displayLabel) {
	...
	public String getTooltip() {
		...
		final StringBuffer sb = new StringBuffer("<html><strong>")
