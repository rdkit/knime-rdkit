 ...
 */
public class RDKitKekulizeNodeFactory 
        extends NodeFactory<RDKitKekulizeNodeModel> {
     ...
     */
    @Override
    public RDKitKekulizeNodeModel createNodeModel() {
        return new RDKitKekulizeNodeModel();
    }
     ...
     */
    @Override
    public NodeView<RDKitKekulizeNodeModel> createNodeView(
            final int viewIndex,
            final RDKitKekulizeNodeModel nodeModel) {
        return null;
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new RDKitKekulizeNodeDialog();
    }
}
