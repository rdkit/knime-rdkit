 ...
 */
public class RDKitMoleculeSubstructFilterSettings {
    private String m_rdkitColumn;

    private String m_queryColumn;
    ...
    /**
     * Returns the name of the column containing the query RDKit molecules.
     *
     * @return the column's name
     */
    ...
    /**
     * Sets the name of the column containing the query RDKit molecules.
     *
     * @param colName the column's name
     */
    public void queryColumn(final String colName) {
        m_queryColumn = colName;
    }
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        ...
        settings.addString("queryColumn", m_queryColumn);
    ...
    public void loadSettings(final NodeSettingsRO settings)
        ...
        m_queryColumn = settings.getString("queryColumn");
    ...
    public void loadSettingsForDialog(final NodeSettingsRO settings) {
        ...
        m_queryColumn = settings.getString("queryColumn", null);
