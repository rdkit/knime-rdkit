 ...
 */
public class RDKitDictSubstructFilterNodeDialogPane extends NodeDialogPane {
    private final ColumnSelectionComboxBox m_rdkitColumn =
            new ColumnSelectionComboxBox((Border)null, RDKitMolValue.class);

    private final ColumnSelectionComboxBox m_smartsColumn =
            new ColumnSelectionComboxBox((Border)null, SmartsValue.class);
     ...
     */
    public RDKitDictSubstructFilterNodeDialogPane() {
        ...
        c.gridx = 0;
        c.gridy++;
        p.add(new JLabel("SMARTS column:   "), c);
        c.gridx = 1;
        p.add(m_smartsColumn, c);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_smartsColumn.update(specs[1], m_settings.smartsColumn());
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        m_settings.smartsColumn(m_smartsColumn.getSelectedColumn());
