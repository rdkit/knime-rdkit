...
public class RDKitOpen3DAlignmentNodeFactory 
     ...
     */
    @Override
    public RDKitOpen3DAlignmentNodeModel createNodeModel() {
     ...
     */
    @Override
    public NodeView<RDKitOpen3DAlignmentNodeModel> createNodeView(
            final int viewIndex,
            final RDKitOpen3DAlignmentNodeModel nodeModel) {
        return null;
    }
