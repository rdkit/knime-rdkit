...
/**
 * <code>NodeFactory</code> for the RDKit based "RDKitMolecule2InChI" Node.
 * 
 *
 * @author Manuel Schwarze
 */
public class RDKitMolecule2InChINodeFactory 
        extends NodeFactory<RDKitMolecule2InChINodeModel> {

    /**
     * Creates a model for the RDKitMolecule2InChI functionality
     ...
     */
    @Override
    public RDKitMolecule2InChINodeModel createNodeModel() {
     ...
     */
    @Override
    public NodeView<RDKitMolecule2InChINodeModel> createNodeView(
            final int viewIndex,
            final RDKitMolecule2InChINodeModel nodeModel) {
        return null;
    }
