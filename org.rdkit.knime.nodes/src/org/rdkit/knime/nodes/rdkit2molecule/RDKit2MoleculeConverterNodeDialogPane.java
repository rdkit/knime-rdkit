 ...
 */
public class RDKit2MoleculeConverterNodeDialogPane extends DefaultNodeSettingsPane {
    /** Possible Value for the output format */
    static String SMILES_FORMAT = "Smiles";
    /** Possible Value for the output format */
    static String SDF_FORMAT = "SDF";
     ...
     */
    static final SettingsModelString createDestinationFormatModel() {
        return new SettingsModelString("destination_format", SDF_FORMAT);
    }
