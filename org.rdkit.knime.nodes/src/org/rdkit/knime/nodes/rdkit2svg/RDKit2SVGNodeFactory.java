 ...
 * Creates a SVG column showing a molecule. 
...
public class RDKit2SVGNodeFactory extends NodeFactory<RDKit2SVGNodeModel> {
	 ...
	 */
	@Override
	public RDKit2SVGNodeModel createNodeModel() {
		return new RDKit2SVGNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<RDKit2SVGNodeModel> createNodeView(
			final int viewIndex,
			final RDKit2SVGNodeModel nodeModel) {
		return null;
	}
