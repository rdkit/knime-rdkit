...
public class RDKitRGroupDecompositionNodeFactory extends NodeFactory<RDKitRGroupDecompositionNodeModel> {
	 ...
	 */
	@Override
	public RDKitRGroupDecompositionNodeModel createNodeModel() {
		return new RDKitRGroupDecompositionNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<RDKitRGroupDecompositionNodeModel> createNodeView(
			final int viewIndex,
			final RDKitRGroupDecompositionNodeModel nodeModel) {
		return null;
	}
