 ...
 */
public class RDKitStructureNormalizerV2NodeFactory
        extends ConfigurableNodeFactory<RDKitStructureNormalizerV2NodeModel> {
    ...
    public NodeDialogPane createNodeDialogPane(NodeCreationConfiguration creationConfig) {
        return new RDKitStructureNormalizerV2NodeDialog(creationConfig);
    }
}
