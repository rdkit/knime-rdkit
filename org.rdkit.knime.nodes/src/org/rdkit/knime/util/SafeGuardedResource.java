...
public abstract class SafeGuardedResource<T> {
	 ...
	 * 		Default is false.
	 */
	public SafeGuardedResource(boolean bShared) {
		m_bShared = bShared;
		m_bIsNull = false;
	...
	public final synchronized void delete() {
		...
		if (m_hResourceAccess != null) {
			Collection<T> collResources = new HashSet<T>(m_hResourceAccess.values());
	 ...
	 */
	protected void disposeResource(T res) {
