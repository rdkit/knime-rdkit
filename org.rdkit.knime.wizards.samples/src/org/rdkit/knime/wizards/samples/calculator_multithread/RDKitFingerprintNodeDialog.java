...
import org.rdkit.knime.wizards.samples.calculator_multithread.RDKitFingerprintNodeModel.FingerprintType;
...
public class RDKitFingerprintNodeDialog extends DefaultNodeSettingsPane {
	...
	RDKitFingerprintNodeDialog() {
		...
		super.addDialogComponent(new DialogComponentEnumSelection<FingerprintType>(
				...
				FingerprintType.atompair, FingerprintType.torsion, FingerprintType.rdkit,
